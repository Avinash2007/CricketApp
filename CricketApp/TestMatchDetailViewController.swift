//
//  TestMatchDetailViewController.swift
//  CricketApp
//
...
class TestMatchDetailViewController: UIViewController,GADBannerViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        if objMatchSoda != nil {
            ...
            else if objMatchSoda.teamCode == "Team2"
            {
                ...
                segmentTeamCode.selectedSegmentIndex = 2
            }
        ...
        segmentTeamCode .setTitle(objMatch.team3, forSegmentAt: 2)
    ...
    @IBAction func btnAddClicked()
    {
        ...
        if objMatchSoda != nil {
            ...
            else if segmentTeamCode.selectedSegmentIndex == 1{
                objMatchSoda.teamCode = "Team2"
            }
            else{
                objMatchSoda.teamCode = "Team3"
            }
            ...
            {
                objMatchSoda.commision = objBookie.testCommission
            }
